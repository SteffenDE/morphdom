...
var morphdom = (function() {
  ...
  var init_morphAttrs = __esm({
    "src/morphAttrs.js": function() {
  ...
  var range, NS_XHTML, doc, HAS_TEMPLATE_SUPPORT, HAS_RANGE_SUPPORT;
  var init_util = __esm({
    "src/util.js": function() {
  ...
  var init_specialElHandlers = __esm({
    "src/specialElHandlers.js": function() {
      specialElHandlers_default = {
  ...
  var ELEMENT_NODE, DOCUMENT_FRAGMENT_NODE2, TEXT_NODE, COMMENT_NODE;
  var init_morphdom = __esm({
    "src/morphdom.js": function() {
      "use strict";
      init_util();
      init_specialElHandlers();
      ELEMENT_NODE = 1;
      DOCUMENT_FRAGMENT_NODE2 = 11;
      TEXT_NODE = 3;
      COMMENT_NODE = 8;
    }
  });
  ...
  // src/index.js
  var morphdom, src_default;
  var init_src = __esm({
    "src/index.js": function() {
      init_morphAttrs();
      init_morphdom();
      morphdom = morphdomFactory(morphAttrs);
      src_default = morphdom;
    }
  });

  // morphdom-browser-entry.js
  var require_morphdom_browser_entry = __commonJS({
    "morphdom-browser-entry.js": function(exports, module) {
      init_src();
      module.exports = src_default;
    }
  });
  return require_morphdom_browser_entry();
})();
